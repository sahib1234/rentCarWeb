...
const i=new URL(e)
const s=new URL(t)
return i.origin===s.origin}var T,S,z=function(e,t){return function(){return e.apply(t,arguments)}},w=function(e,t){for(var i in t)A.call(t,i)&&(e[i]=t[i])
...
S=function(){return r.a.includes(ENV.current_user_roles,"student")}
t["a"]=function(e){w(t,e)
function t(){this.quizzesRespondusEnabled=z(this.quizzesRespondusEnabled,this)
this.showGradersAnonymousToGradersCheckbox=z(this.showGradersAnonymousToGradersCheckbox,this)
this.pollUntilFinished=z(this.pollUntilFinished,this)
this.pollUntilFinishedLoading=z(this.pollUntilFinishedLoading,this)
this.pollUntilFinishedMigrating=z(this.pollUntilFinishedMigrating,this)
this.pollUntilFinishedImporting=z(this.pollUntilFinishedImporting,this)
this.pollUntilFinishedDuplicating=z(this.pollUntilFinishedDuplicating,this)
this.retry_migration=z(this.retry_migration,this)
this.duplicate_failed=z(this.duplicate_failed,this)
this.duplicate=z(this.duplicate,this)
this.setNullDates=z(this.setNullDates,this)
this._filterFrozenAttributes=z(this._filterFrozenAttributes,this)
this._getAssignmentType=z(this._getAssignmentType,this)
this._hasOnlyType=z(this._hasOnlyType,this)
this._submissionTypes=z(this._submissionTypes,this)
this.toView=z(this.toView,this)
this.submissionTypesFrozen=z(this.submissionTypesFrozen,this)
this.failedToImport=z(this.failedToImport,this)
this.isImporting=z(this.isImporting,this)
this.isQuizLTIAssignment=z(this.isQuizLTIAssignment,this)
this.is_quiz_assignment=z(this.is_quiz_assignment,this)
this.originalAssignmentName=z(this.originalAssignmentName,this)
this.originalAssignmentID=z(this.originalAssignmentID,this)
this.originalQuizID=z(this.originalQuizID,this)
this.originalCourseID=z(this.originalCourseID,this)
this.failedToMigrate=z(this.failedToMigrate,this)
this.failedToDuplicate=z(this.failedToDuplicate,this)
this.isMigrating=z(this.isMigrating,this)
this.isDuplicating=z(this.isDuplicating,this)
this.canDuplicate=z(this.canDuplicate,this)
this.singleSectionDueDate=z(this.singleSectionDueDate,this)
this.allDates=z(this.allDates,this)
this.nonBaseDates=z(this.nonBaseDates,this)
this.hasPointsPossible=z(this.hasPointsPossible,this)
this.hasDueDate=z(this.hasDueDate,this)
this.multipleDueDates=z(this.multipleDueDates,this)
this.defaultDates=z(this.defaultDates,this)
this.dueDateRequiredForAccount=z(this.dueDateRequiredForAccount,this)
this.maxNameLengthRequiredForAccount=z(this.maxNameLengthRequiredForAccount,this)
this.maxNameLength=z(this.maxNameLength,this)
this.sisIntegrationSettingsEnabled=z(this.sisIntegrationSettingsEnabled,this)
this.postToSISName=z(this.postToSISName,this)
this.postToSISEnabled=z(this.postToSISEnabled,this)
this.labelId=z(this.labelId,this)
this.htmlEditUrl=z(this.htmlEditUrl,this)
this.htmlUrl=z(this.htmlUrl,this)
this.objectType=z(this.objectType,this)
this.iconType=z(this.iconType,this)
this.useNewQuizIcon=z(this.useNewQuizIcon,this)
this.published=z(this.published,this)
this.isGpaScaled=z(this.isGpaScaled,this)
this.isLetterGraded=z(this.isLetterGraded,this)
this.isSimple=z(this.isSimple,this)
this.externalToolNewTab=z(this.externalToolNewTab,this)
this.externalToolUrl=z(this.externalToolUrl,this)
this.gradingStandardId=z(this.gradingStandardId,this)
this.groupCategoryId=z(this.groupCategoryId,this)
this.vericiteEnabled=z(this.vericiteEnabled,this)
this.turnitinEnabled=z(this.turnitinEnabled,this)
this.gradeGroupStudentsIndividually=z(this.gradeGroupStudentsIndividually,this)
this.vericiteAvailable=z(this.vericiteAvailable,this)
this.turnitinAvailable=z(this.turnitinAvailable,this)
this.allowedExtensions=z(this.allowedExtensions,this)
this.restrictFileExtensions=z(this.restrictFileExtensions,this)
this.notifyOfUpdate=z(this.notifyOfUpdate,this)
this.peerReviewsAssignAt=z(this.peerReviewsAssignAt,this)
this.peerReviewCount=z(this.peerReviewCount,this)
this.automaticPeerReviews=z(this.automaticPeerReviews,this)
this.anonymousPeerReviews=z(this.anonymousPeerReviews,this)
this.peerReviews=z(this.peerReviews,this)
this.graderCommentsVisibleToGraders=z(this.graderCommentsVisibleToGraders,this)
this.gradersAnonymousToGraders=z(this.gradersAnonymousToGraders,this)
this.anonymousGrading=z(this.anonymousGrading,this)
this.anonymousInstructorAnnotations=z(this.anonymousInstructorAnnotations,this)
this.moderatedGrading=z(this.moderatedGrading,this)
this.postToSIS=z(this.postToSIS,this)
this.isOnlineSubmission=z(this.isOnlineSubmission,this)
this.acceptsOnlineTextEntries=z(this.acceptsOnlineTextEntries,this)
this.acceptsMediaRecording=z(this.acceptsMediaRecording,this)
this.acceptsOnlineURL=z(this.acceptsOnlineURL,this)
this.acceptsOnlineUpload=z(this.acceptsOnlineUpload,this)
this.withoutGradedSubmission=z(this.withoutGradedSubmission,this)
this.hasSubmittedSubmissions=z(this.hasSubmittedSubmissions,this)
this.allowedToSubmit=z(this.allowedToSubmit,this)
this.expectsSubmission=z(this.expectsSubmission,this)
this.submissionType=z(this.submissionType,this)
this.isNonDefaultExternalTool=z(this.isNonDefaultExternalTool,this)
this.defaultToolSelected=z(this.defaultToolSelected,this)
this.isQuickCreateDefaultTool=z(this.isQuickCreateDefaultTool,this)
this.defaultToOnPaper=z(this.defaultToOnPaper,this)
this.defaultToOnline=z(this.defaultToOnline,this)
this.defaultToNone=z(this.defaultToNone,this)
this.isDefaultTool=z(this.isDefaultTool,this)
this.shouldShowDefaultTool=z(this.shouldShowDefaultTool,this)
this.isNewAssignment=z(this.isNewAssignment,this)
this.submissionTypes=z(this.submissionTypes,this)
this.courseID=z(this.courseID,this)
this.omitFromFinalGrade=z(this.omitFromFinalGrade,this)
this.gradingType=z(this.gradingType,this)
this.inClosedGradingPeriod=z(this.inClosedGradingPeriod,this)
this.frozenAttributes=z(this.frozenAttributes,this)
this.frozen=z(this.frozen,this)
this.freezeOnCopy=z(this.freezeOnCopy,this)
this.canMove=z(this.canMove,this)
this.canDelete=z(this.canDelete,this)
this.canFreeze=z(this.canFreeze,this)
this.assignmentGroupId=z(this.assignmentGroupId,this)
this.secureParams=z(this.secureParams,this)
this.pointsPossible=z(this.pointsPossible,this)
this.name=z(this.name,this)
this.description=z(this.description,this)
this.dueDateRequired=z(this.dueDateRequired,this)
this.lockAt=z(this.lockAt,this)
this.unlockAt=z(this.unlockAt,this)
this.dueAt=z(this.dueAt,this)
this.assignmentType=z(this.assignmentType,this)
this.isAssignment=z(this.isAssignment,this)
this.isNotGraded=z(this.isNotGraded,this)
this.defaultToolUrl=z(this.defaultToolUrl,this)
this.defaultToolName=z(this.defaultToolName,this)
this.isExternalTool=z(this.isExternalTool,this)
this.isPage=z(this.isPage,this)
this.isDiscussionTopic=z(this.isDiscussionTopic,this)
this.isQuiz=z(this.isQuiz,this)
...
t.prototype.useNewQuizIcon=function(){return ENV.FLAGS&&ENV.FLAGS.newquizzes_on_quiz_page&&(this.isQuiz()&&S()||this.isQuizLTIAssignment())}
...
return"Assignment"}
t.prototype.objectTypeDisplayName=function(){if(this.isQuiz()||this.isQuizLTIAssignment()&&S())return g.t("Quiz")
...
t.prototype.defaultDates=function(){return new _["a"]({due_at:this.get("due_at"),unlock_at:this.get("unlock_at"),lock_at:this.get("lock_at")})}
...
null!=(i=e.assignment_overrides)&&(e.assignment_overrides=new h["a"](i))
...
i=this.attributes
for(t in i){if(!A.call(i,t))continue
i[t]
...
t.prototype.quizzesRespondusEnabled=function(){return this.get("require_lockdown_browser")&&this.isQuizLTIAssignment()&&S()}
...
var a=i("yS2Q")
var u=i("mmEa")
var l=function(e,t){return function(){return e.apply(t,arguments)}},c=function(e,t){for(var i in t)_.call(t,i)&&(e[i]=t[i])
function s(){this.constructor=e}s.prototype=t.prototype
e.prototype=new s
e.__super__=t.prototype
...
s=[]
t={}
e.exports=i=function(e,i,n){var o,r,a,u,l,c,_,h,d
null==n&&(n=true)
...
o=(null!=i?i.decimal:void 0)||t.decimal}_=""+d+o+n
c=s[_]
if(null==c){a=n?3:1
c=s[_]=new RegExp("^\\s*([+-]?(?:(?:\\d{1,3}(?:\\"+d+"\\d{"+a+",3})+)|\\d*))(?:\\"+o+"(\\d*))?\\s*$")}h=e.match(c)
if(!(null!=h&&3===h.length))return NaN
u=h[1].replace(new RegExp("\\"+d,"g"),"")
r=h[2]
l=parseFloat(u+"."+r)
return l}
...
var _=i("cbNQ")
var h=function(e,t){return function(){return e.apply(t,arguments)}},d=function(e,t){for(var i in t)p.call(t,i)&&(e[i]=t[i])
function s(){this.constructor=e}s.prototype=t.prototype
e.prototype=new s
e.__super__=t.prototype
...
t.conditionalRelease=Object(_["b"])({noop_id:"1"},{name:function(){return c.t("Mastery Paths")}})
...
//# sourceMappingURL=25-c-78587bf58a.js.map